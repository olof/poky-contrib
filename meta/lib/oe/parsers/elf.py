# This is a mostly generated file from Kaitai Struct. The upstream elf.ksy is
# used to generate this file which is then modified with the following changes:
#
# * Wrap the parse_version test in a try/except block.
# * Add pax_flags to PhType (upstreamed)

from oe.parsers.kaitaistruct import __version__ as ks_version, KaitaiStruct, KaitaiStream, BytesIO
